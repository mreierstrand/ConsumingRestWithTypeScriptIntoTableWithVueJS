...
var baseUrl = "https://restinmemoryeksempel2.azurewebsites.net/api/transporterTabs";
...
new Vue({
    ...
    methods: {
        getAllTransporters: function () {
            var _this = this;
            console.log("getAllTransporters");
            _node_modules_axios_index__WEBPACK_IMPORTED_MODULE_0___default.a.get(baseUrl)
